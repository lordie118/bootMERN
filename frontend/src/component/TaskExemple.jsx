...
import { addTask, deleteTask, editTask, fetchTasks, searchTasks, setFilter, } from '../redux/slices/taskSlice'; // Adapte le chemin selon l'emplacement du fichier
                ...
                tasks.map((t) => (
                    <tr class="border-b dark:border-gray-700" key={t.id}>  {/* Assuming each task has an id */}
                        ...
                        <button 
                            ...
                            <button 
                               onClick={()=>confirmDeleteTask(t._id)} 
